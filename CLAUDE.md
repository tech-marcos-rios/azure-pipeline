...
- [ ] Caddy + DNS (`ops.marcosrios.dev` con `basicauth`, apuntando al puerto `:5041` del `web`) — sin hacer. Hoy el dashboard solo es alcanzable desde el propio server (`localhost:5040`/`:5041`) o por túnel SSH, no tiene URL pública todavía.
- [ ] Actualizar `docs/INFRAESTRUCTURA.md` con el proyecto.
